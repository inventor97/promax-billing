...
public class windowCtrl {
    ...
    public static void makeToast(String toastMsg) {
        ...
        text.setStyle("-fx-font-weight: bold; -fx-text-fill: #2a4e8b");
        text.setFont(Font.font("Montserrat", 24));

        StackPane root = new StackPane(text);
        root.setPadding(new Insets(5, 10, 5, 10));
        root.setId("toastPane");
        root.setOpacity(0);
        root.setStyle("-fx-background-radius: 5;-fx-background-color: #84D894");
